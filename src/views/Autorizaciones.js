...
const data = [
  { aut: "Estudio" , fecha: "12/01/2019", descripcion: "Análisis de sangre", medico:"Dr. B" },
  { aut: "Estudio" , fecha: "15/09/2017", descripcion: "Rayos", medico:"Dr.A" },
  { aut: "Tratamiento" , fecha: "06/04/2007", descripcion: "Quimioterapia", medico:"Dr.E" },
      ...
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="primary">
            <h4 className={classes.cardTitleWhite}>Autorizaciones</h4>
            <p className={classes.cardCategoryWhite}>
              Estudios/Tratamientos/Operaciones
            </p>
          </CardHeader>
          <CardBody>
            <div>
            <Table>
             <TableHead color="primary">
              <TableRow>
                <TableCell aling="left">Autorización</TableCell>
             ...
             <TableBody>
               {data.map((dato) => (
                 ...
                 <TableCell component="th" scope="row">{dato.aut}</TableCell>
      ...
      <Dialog
        ...
        <DialogTitle
            ...
            <IconButton
                ...
                >
                  <p>
                  Aca va la observacion de la autorizacion
                  </p>
                  </DialogContent>
